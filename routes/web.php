...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('dashboard/cliente')->middleware('role:cliente_qr')->group(function () {
        ...
        Route::get('/registrar-mascota', [PetController::class, 'create'])->name('pets.create');
        Route::post('/registrar-mascota', [PetController::class, 'store'])->name('pets.store');
        Route::get('/mascota/{id}', [PetController::class, 'show'])->name('dashboard.show');
        Route::get('dashboard/cliente/mascota/{id}/edit', [PetController::class, 'edit'])->name('dashboard.edit');
        Route::put('dashboard/cliente/mascota/{id}', [PetController::class, 'update'])->name('pets.update');
    ...
    Route::prefix('dashboard/administrador')->middleware('role:administrador|super_admin')->group(function () {
        Route::get('/', [DashboardController::class, 'index'])->name('dashboard.administrador');
    ...
    // Rutas para obtener el rol y permisos del usuario autenticado
