    ...
    <div class="lg:ml-64 transition-all duration-300 ease-in-out">
        <div class="min-h-screen bg-gray-50">
            <div class="p-4 sm:p-6 lg:p-8">
                {{-- Header Section --}}
                <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 sm:mb-8 pb-4 border-b border-gray-200">
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Mis Mascotas</h1>
